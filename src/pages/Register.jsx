          ...
          <form onSubmit={handleRegister}>
            ...
            <div className="input-eye">
              <input
                ...
                required
                style={{
                  borderColor: passwordMatch === null ? "#ddd" : passwordMatch ? "#8AA12F" : "#e53935",
                }}
              />
            ...
            {passwordMatch === false && (
              <p style={{ color: "#e53935", fontSize: "0.72rem", marginTop: "4px", textAlign: "left" }}>
                Passwords do not match
              </p>
            )}
            {passwordMatch === true && (
              <p style={{ color: "#8AA12F", fontSize: "0.72rem", marginTop: "4px", textAlign: "left" }}>
                Passwords match ✓
              </p>
            )}
