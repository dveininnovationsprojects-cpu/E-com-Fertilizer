        ...
        <footer className="w-full bg-[#F3F4ED] pt-20">
            <div className="max-w-7xl mx-auto px-10 pb-20 grid grid-cols-1 md:grid-cols-3 gap-16">
                <div className="space-y-6">
                    <h2 className="text-3xl font-black text-[#333]">SARASWATHY</h2>
                ...
                <div className="flex flex-col justify-center items-center md:items-end">
                    <img src="https://cdn-icons-png.flaticon.com/512/3043/3043229.png" alt="footer-logo" className="h-24 w-24 opacity-10" />
                </div>
            </div>
